  ...
  <body>
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn shadow-none d-flex align-items-center justify-content-between bg-dark text-white w-100" data-bs-toggle="collapse" href="#navbar-vertical" role="button" aria-expanded="false" aria-controls="navbar-vertical" style="height: 65px; margin-top: -1px; padding: 0 30px;">
                    <h6 class="m-0">Categories</h6>
                    <i class="bi bi-chevron-down text-white"></i>
                </a>
                <nav class="collapse navbar navbar-vertical navbar-white align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
